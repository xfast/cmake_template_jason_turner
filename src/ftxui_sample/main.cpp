...
// configuration step. It creates a namespace called `cmake_template_jason_turner`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_template_jason_turner::cmake::project_name, cmake_template_jason_turner::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_template_jason_turner::cmake::project_version);
      return EXIT_SUCCESS;
    }
